...
node_highres_N4Correction = pe.Node(interface=ants.N4BiasFieldCorrection(), name='node_highres_N4Correction')
node_highres_N4Correction.inputs.input_image = root_dir + nipype_dir + highres
node_highres_N4Correction.inputs.output_image = root_dir + nipype_dir + highres_N4

node_highres_fsl_multiply = pe.Node(interface=fsl.BinaryMaths(), name='node_highres_fsl_multiply')
#node_highres_fsl_multiply.inputs.in_file = root_dir + nipype_dir + highres_N4
node_highres_fsl_multiply.inputs.operand_file = root_dir + nipype_dir + highres_mask
node_highres_fsl_multiply.inputs.operation = "mul"
node_highres_fsl_multiply.inputs.out_file = root_dir + nipype_dir + highres_N4_bet
...
#node_fslmath_binarize.inputs.in_file = root_dir + nipype_dir + highres_N4_bet
...
#node_mRs.inputs.in_file = root_dir + nipype_dir + highres_N4
...
test_geo_workflow.base_dir = root_dir + workflow_dir
...
test_geo_workflow.add_nodes([node_highres_N4Correction])
test_geo_workflow.add_nodes([node_highres_fsl_multiply])
...
test_geo_workflow.connect(node_highres_N4Correction, 'output_image', node_mRs, 'in_file')
test_geo_workflow.connect(node_highres_N4Correction, 'output_image',  node_highres_fsl_multiply, 'in_file')
test_geo_workflow.connect(node_highres_fsl_multiply, 'out_file', node_fslmath_binarize, 'in_file')
test_geo_workflow.connect(node_highres_fsl_multiply, 'out_file', node_mRs_highres_bet, 'in_file')
test_geo_workflow.connect(node_fslmath_binarize, 'out_file', node_mRs_highres_mask, 'in_file')

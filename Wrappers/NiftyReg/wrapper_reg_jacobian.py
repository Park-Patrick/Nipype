...
class reg_jacobianOutputSpec(TraitedSpec):
    outfile_jacobianLog = File(exists=True, desc='outfile_jacobianLog')
    outfile_jacobianMatrix = File(exists=True, desc='outfile_jacobianMatrix')
    outfile_jacobianDeterminant = File(exists=True, desc='outfile_jacobianDeterminant')
